...
import { DownloadDocumentoUseCase } from '../../application/use-cases/documento-venta/download-documento.use-case';
...
export const downloadDocumentoUseCase = new DownloadDocumentoUseCase(documentoVentaRepository);
